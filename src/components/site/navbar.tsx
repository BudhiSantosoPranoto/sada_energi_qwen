...
export function Navbar() {
  ...
  return (
    ...
    >
      <div className="container-brand flex h-24 items-center justify-between gap-4 lg:h-30">
        {/* Logo */}
      ...
      <div
        className={cn(
          "lg:hidden fixed inset-0 top-30 z-40 transition-all duration-300",
